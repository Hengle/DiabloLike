...
#pragma warning restore 0414
    ...
    //Marks a certain message as permanent.永远不清楚的消息
    ...
    static private void OnListenerAdding(EGameEvent eventType, Delegate listenerBeingAdded)
    {
    ...
    static private void OnListenerRemoving(EGameEvent eventType, Delegate listenerBeingRemoved) {
#if LOG_ALL_MESSAGES
    ...
    static private void OnListenerRemoved(EGameEvent eventType)
    {
    ...
    static private void OnBroadcasting(EGameEvent eventType)
    {
#if REQUIRE_LISTENER
        if (!mEventTable.ContainsKey(eventType)) {
        }
    ...
    static private BroadcastException CreateBroadcastSignatureException(EGameEvent eventType)
    {
