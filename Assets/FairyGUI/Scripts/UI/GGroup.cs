...
namespace FairyGUI
{
	...
	public class GGroup : GObject
	{
        ...
        // Edit 是否只布局可显示的孩子对象
        public bool onlyLayoutVisibleChild = false;
        ...
        // Edit 开放给子类覆盖
        protected virtual void HandleLayout()
		{
			_updating |= 1;
        ...
        // Edit 开放给子类覆盖
		virtual internal void ResizeChildren(float dw, float dh)
		{
