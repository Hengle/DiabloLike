...
#pragma warning restore 0649
        ...
        public static DisplayObject GetTouchTarget()
        {
            if (_inst == null || _inst.touchTarget == null)
                return null;
            return _inst.touchTarget;
        }
		...
		public DisplayObject touchTarget
		{
			get
			{
                ...
                if (_touchTarget == this)   //add by dong 增加忽略容器
                    return null;
                else
                {
                    return _touchTarget;
        ...
        // Edit FGUI修改
        public void PlayOneShotSound(NAudioClip clip, float volumeScale)
        {
